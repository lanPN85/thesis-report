...
Another approach, as implemented by the authors of the DistBelief framework \cite{dean2012large}, is to distribute the network graph on multiple nodes (Figure \ref{fig:model_parallel}). This approach is often suited for networks with very "wide" layers.

\begin{figure}[htp]
	\centering
	\includegraphics[width=0.7\textwidth]{model_parallel.png}
	\caption{Model parallelism in DistBelief}
