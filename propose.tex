...
At a high level, BK.Synapse consists of 4 primary components: the API server, worker nodes, data store, and the web application (Figure \ref{fig:architecture}).
